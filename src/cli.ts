...
program
  ...
  .requiredOption("--data-source <id>", "Notion data source ID")
  ...
  .option("--optimize-images", "optimize images (convert to WebP)", true)
  .option("--optimize-videos [formats]", "optimize videos (convert to H.264/AAC with ffmpeg). Specify formats to convert (e.g. \"mov,avi\"). WebM and MP4 are excluded by default. Use \"all\" to convert all formats. Requires ffmpeg to be installed separately.")
